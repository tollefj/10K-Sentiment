...
companyListFile = os.path.join(os.getcwd(),"CompanyList.csv") #a csv file with the list of company ticker symbols and names (the file has a line with headers)
IndexLinksFile = os.path.join(os.getcwd(), "IndexLinks.csv") #a csv file (output of the current script) with the list of index links for each firm (the file has a line with headers)
