...
os.chdir(os.getcwd())#<===The location of your file "LongCompanyList.csv
...
def main():
    ...
    FormYears = ['2014','2016'] ### <=== Type the years of documents to download here
